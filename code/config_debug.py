...
parser.add_argument(
    "--all_wsi",
    type=Path,
    default=Path("/disk1/zhangyingxin/project/lung/deepslide-master/all_wsi"),
...
parser.add_argument("--wsi_train",
                    type=Path,
                    default=Path("/disk1/zhangyingxin/project/lung/deepslide-master/wsi_train"),
                    help="Location to be created to store WSI for training")
parser.add_argument("--wsi_val",
                    type=Path,
                    default=Path("/disk1/zhangyingxin/project/lung/deepslide-master/wsi_val"),
                    help="Location to be created to store WSI for validation")
parser.add_argument("--wsi_test",
                    type=Path,
                    default=Path("/disk1/zhangyingxin/project/lung/deepslide-master/wsi_test"),
                    help="Location to be created to store WSI for testing")

# Where the CSV file labels will go.
parser.add_argument("--labels_train",
                    type=Path,
                    default=Path("/disk1/zhangyingxin/project/lung/deepslide-master/labels_train.csv"),
                    help="Location to store the CSV file labels for training")
parser.add_argument(
    "--labels_val",
    type=Path,
    default=Path("/disk1/zhangyingxin/project/lung/deepslide-master/labels_val.csv"),
    help="Location to store the CSV file labels for validation")
parser.add_argument("--labels_test",
                    type=Path,
                    default=Path("/disk1/zhangyingxin/project/lung/deepslide-master/labels_test.csv"),
...
parser.add_argument(
    "--train_folder",
    type=Path,
    default=Path("/disk1/zhangyingxin/project/lung/daping_grade2/paper_script/512px_tiled_0"),
...
classes =['AAH','AIS','BG','LPA','MIA'] #get_classes(folder=args.all_wsi)
num_classes = 5#len(classes)
