...
# n/*.jpg with the images in class n.   原default为 Path("all_wsi")，根据新疆的进行修改1.31
#Path('/disk1/zhangyingxin/project/lung/xinjiang_grade2/second_instalment/data/stitch_test')
parser.add_argument(
    "--all_wsi",
    type=Path,
    default=Path("all_wsi_daping"),
...
parser.add_argument("--checkpoints_folder",
                    type=Path,
                    default=Path("checkpoints_preweight"),#zyx change
...
parser.add_argument(
    "--checkpoint_file",
    type=Path,
    default=Path("resnet18_e21_va0.99659.pt"),#zyx change
...
classes=['Acinar','BG','LPA','Micropapillary','Papillary','Solid']
num_classes = 6
# classes=['luad','lusc','normal']  zyx change
# num_classes = 3
# This is the input for model training, automatically built.
...
path_mean, path_std = compute_stats(folderpath=args.all_wsi,
                                    image_ext='png')#args.image_ext
print(path_mean,path_std)
#sys.exit(0)
...
# ("red", "white", "blue", "green", "purple", "orange", "black", "pink","yellow")
